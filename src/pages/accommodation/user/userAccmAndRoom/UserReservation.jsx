...
const UserReservation = () => {
    ...
    const PaymentModal = ({ open, onClose, url }) => {
        ...
        //     // 먼저 다이얼로그를 열어 사용자에게 애니메이션을 보여줍니다
        //     setOpen(true);
        //     console.log("test");
        ...
        //         a_r_no: dataForPayment.a_r_no,
        //         u_r_check_in: dataForPayment.u_r_check_in,
        //         u_r_check_out: dataForPayment.u_r_check_out,
        //         u_r_stay_yn: dataForPayment.u_r_stay_yn,
        //         u_r_car_yn: dataForPayment.u_r_car_yn,
        //         a_r_price: dataForPayment.a_r_price,
        //         a_acc_name: dataForPayment.a_acc_name,
        //         a_r_name: dataForPayment.a_r_name,
        //         a_r_check_in: dataForPayment.a_r_check_in,
        //         a_r_check_out: dataForPayment.a_r_check_out,
        //         a_acc_no: dataForPayment.a_acc_no,
        //         a_acc_name: dataForPayment.a_acc_name,
        //         next_redirect_pc_url: nextRedirectPcUrl,
        //         tid: tid,
        //         created_at: created_at,
        ...
        //     if (response.data) {
        //         navigate(`/payment/success`, { state: location });
        //     }
        // }
