...
const RegistRoom = () => {
    ...
    const fetchData = async () => {
        try {
            const res = await api.post(`https://soonmin.info/api/admin/accm/show_accm_detail?a_m_no=${paramsData.a_m_no}`);
            //  res -> 서버에서 받아온 데이터
    ...
    const registRoomConfirm = async (e) => {
        ...
        try {
            const response = await api.post("https://soonmin.info/api/admin/room/registConfirm",
                data, {
                headers: {
